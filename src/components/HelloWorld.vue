<template>
  <div class="hello">
    ...
    <p>
      ...
      check out the
      <a href="https://cli.vuejs.org" rel="noopener" target="_blank">vue-cli
        documentation</a>.
    </p>
    ...
    <ul>
      ...
      <li><a href="https://chat.vuejs.org" rel="noopener" target="_blank">Community
        Chat</a></li>
      <li><a href="https://twitter.com/vuejs" rel="noopener" target="_blank">Twitter</a>
      </li>
    ...
    <ul>
      ...
      <li><a href="https://vue-loader.vuejs.org" rel="noopener"
